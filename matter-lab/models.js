...
modelRegistry.push(
  ...
  { id:'cosmicString', family:'exotic', title:'Cosmic string', subtitle:'Topological-defect field configuration', status:'theoretical', statusLabel:'THEORETICAL MODEL', description:'A one-dimensional topological defect predicted in some symmetry-breaking models. The local display is a field-defect illustration.', formula:'mu approx 2 pi eta^2; delta T/T proportional to G mu', applicability:'Cosmic strings have not been detected. Observational limits constrain tension in particular network models.', visual:'crystalMatter', interaction:'field', parameters:[{key:'tension',label:'String tension',unit:'Gmu',min:1e-12,max:1e-6,step:1e-12,value:1e-8},{key:'networkDensity',label:'Network density',min:.1,max:5,step:.1,value:1}], sources:[['Cosmic-string review','https://arxiv.org/abs/1010.2511'],['Einstein Toolkit','https://einsteintoolkit.org/']] },
